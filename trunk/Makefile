...
OBJECTS = main/main.o arch/switch.o task/requests.o main/td.o task/task.o main/syscalls.o server/clockserver.o server/nameserver.o task/gameserver.o task/gameplayer.o driver/drivers.o
