...
OBJECTS = arch/switch.o driver/drivers.o main/main.o main/syscalls.o main/td.o server/clockserver.o server/nameserver.o task/gameplayer.o task/gameserver.o task/requests.o task/shell.o task/task.o 
